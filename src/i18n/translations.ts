...
const en = {
  ...
  "drawtable.instructionMerge":
    "Click a column between vertical lines to toggle its merge",
  ...
  "drawtable.mergeColumn": "Merge column (click column regions to toggle)",
...
const zh: Record<TranslationKey, string> = {
  ...
  "drawtable.instructionMerge": "点击竖线间的列区域切换该列是否合并",
  ...
  "drawtable.mergeColumn": "合并列(点选列区域切换)",
